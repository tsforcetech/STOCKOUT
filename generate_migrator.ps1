$MigratorPath = "c:\DEV\API PROJECT\STOCKOUT\services\identity-access\Emcore.IdentityAccess.Migrator"
...
"@
Set-Content -Path "$MigratorPath\Emcore.IdentityAccess.Migrator.csproj" -Value $csproj
