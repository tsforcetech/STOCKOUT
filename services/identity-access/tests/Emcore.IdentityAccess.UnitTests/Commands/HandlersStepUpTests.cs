...
public class HandlersStepUpTests
{
    ...
    [Fact]
    public async Task VerifyStepUpAsync_WithoutSessionId_ShouldFail()
    {
    ...
    [Fact]
    public async Task InitiateStepUpAsync_WithInvalidTargetAction_ShouldFail()
    {
    ...
    [Fact]
    public async Task VerifyStepUpAsync_WithWrongSession_ShouldFail()
    {
        var challenge = new StepUpChallenge
        {
            Id = "stepUp123",
        ...
        _mockRepo.Setup(x => x.GetStepUpChallengeAsync("stepUp123", "user123", It.IsAny<CancellationToken>())).ReturnsAsync(challenge);
