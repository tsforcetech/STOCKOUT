...
namespace Emcore.IdentityAccess.ArchitectureTests;

public class DependencyRulesTests
{
    private const string DomainNamespace = "Emcore.IdentityAccess.Domain";
    private const string ApplicationNamespace = "Emcore.IdentityAccess.Application";
    private const string InfrastructureNamespace = "Emcore.IdentityAccess.Infrastructure";
    private const string ContractsNamespace = "Emcore.IdentityAccess.Contracts";
    private const string ApiNamespace = "Emcore.IdentityAccess.Api";
    private const string WorkerNamespace = "Emcore.IdentityAccess.Worker";
