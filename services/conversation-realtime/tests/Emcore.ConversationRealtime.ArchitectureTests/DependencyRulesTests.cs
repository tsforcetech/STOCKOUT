...
namespace Emcore.ConversationRealtime.ArchitectureTests;

public class DependencyRulesTests
{
    private const string DomainNamespace = "Emcore.ConversationRealtime.Domain";
    private const string ApplicationNamespace = "Emcore.ConversationRealtime.Application";
    private const string InfrastructureNamespace = "Emcore.ConversationRealtime.Infrastructure";
    private const string ContractsNamespace = "Emcore.ConversationRealtime.Contracts";
    private const string ApiNamespace = "Emcore.ConversationRealtime.Api";
    private const string WorkerNamespace = "Emcore.ConversationRealtime.Worker";
