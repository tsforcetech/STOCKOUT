...
namespace Emcore.AuditReporting.ArchitectureTests;

public class DependencyRulesTests
{
    private const string DomainNamespace = "Emcore.AuditReporting.Domain";
    private const string ApplicationNamespace = "Emcore.AuditReporting.Application";
    private const string InfrastructureNamespace = "Emcore.AuditReporting.Infrastructure";
    private const string ContractsNamespace = "Emcore.AuditReporting.Contracts";
    private const string ApiNamespace = "Emcore.AuditReporting.Api";
    private const string WorkerNamespace = "Emcore.AuditReporting.Worker";
