...
namespace Emcore.InspectionTrust.ArchitectureTests;

public class DependencyRulesTests
{
    private const string DomainNamespace = "Emcore.InspectionTrust.Domain";
    private const string ApplicationNamespace = "Emcore.InspectionTrust.Application";
    private const string InfrastructureNamespace = "Emcore.InspectionTrust.Infrastructure";
    private const string ContractsNamespace = "Emcore.InspectionTrust.Contracts";
    private const string ApiNamespace = "Emcore.InspectionTrust.Api";
    private const string WorkerNamespace = "Emcore.InspectionTrust.Worker";
