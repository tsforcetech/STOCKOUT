...
namespace Emcore.SearchDiscovery.ArchitectureTests;

public class DependencyRulesTests
{
    private const string DomainNamespace = "Emcore.SearchDiscovery.Domain";
    private const string ApplicationNamespace = "Emcore.SearchDiscovery.Application";
    private const string InfrastructureNamespace = "Emcore.SearchDiscovery.Infrastructure";
    private const string ContractsNamespace = "Emcore.SearchDiscovery.Contracts";
    private const string ApiNamespace = "Emcore.SearchDiscovery.Api";
    private const string WorkerNamespace = "Emcore.SearchDiscovery.Worker";
