...
namespace Emcore.WorkflowScheduler.ArchitectureTests;

public class DependencyRulesTests
{
    private const string DomainNamespace = "Emcore.WorkflowScheduler.Domain";
    private const string ApplicationNamespace = "Emcore.WorkflowScheduler.Application";
    private const string InfrastructureNamespace = "Emcore.WorkflowScheduler.Infrastructure";
    private const string ContractsNamespace = "Emcore.WorkflowScheduler.Contracts";
    private const string ApiNamespace = "Emcore.WorkflowScheduler.Api";
    private const string WorkerNamespace = "Emcore.WorkflowScheduler.Worker";
